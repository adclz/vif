...
const TestProgram = () => {
    const fb = new Fb({
            ...
            body() {
                return [
                    new Assign(this.temp.test_real, new Sin(new Real(0.9))),
                    new UnitTest("Real sin", this.temp.test_real, ">=", 0.7833269),

                    new Assign(this.temp.test_lreal, new Sin(new LReal(0.9))),
        ...
        blocks:
            {
                ...
                "Sin_Fb": fb,
                "Sin_Fb_Instance": fbInstance
            }
    })
}

describe("Simulation primitives", async () => {
    describe("Sin Values", async () => {
        describe("Simulation tests", async () => {
            ...
            describe("Compiler output", () => {
                ...
                it("output", () => {
                    ...
                    expect(output["file:///Sin_Fb"]).to.toMatchObject([
                        "FUNCTION_BLOCK \"Sin_Fb\"",
