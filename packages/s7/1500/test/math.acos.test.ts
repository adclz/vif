...
const TestProgram = () => {
    const fb = new Fb({
            ...
            body() {
                return [
                    new Assign(this.temp.test_real, new ACos(0.9)),
                    new UnitTest("Real acos approx", this.temp.test_real, "<=", 0.4510269),
                    new UnitTest("Real acos approx", this.temp.test_real, ">=", 0.4510268),

                    new Assign(this.temp.test_lreal, new ACos(0.9)),
                    new UnitTest("LReal acos approx", this.temp.test_lreal, "<=", 0.4510269),
                    new UnitTest("LReal acos approx", this.temp.test_lreal, ">=", 0.4510268),
                ]
            }
        }
    )
        ...
        blocks:
            {
                ...
                "Acos_Fb": fb,
                "Acos_Fb_Instance": fbInstance
            }
    })
}

describe("Simulation primitives", async () => {
    describe("Acos Values", async () => {
        describe("Simulation tests", async () => {
            ...
            describe("Compiler output", () => {
                ...
                it("output", () => {
                    ...
                    expect(output["file:///Acos_Fb"]).to.toMatchObject([
                        "FUNCTION_BLOCK \"Acos_Fb\"",
