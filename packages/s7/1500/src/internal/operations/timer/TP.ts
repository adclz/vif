...
export class TP<T extends IEC_Timer_Interface> extends Template {
    constructor() {
        super(() => {
            return [
                //Assign inputs
                //new Assign(new Resolve(["#inner", "PT"]), new Resolve(["PT"])),
                //new Assign(new Resolve(["#inner", "IN"]), new Resolve(["IN"])),
                ...
                // Assign outputs
                //new Assign(new Resolve(["ET"]), new Resolve(["#inner", "ET"])),
                //new Assign(new Resolve(["Q"]), new Resolve(["#inner", "Q"]))
            ]
        })
    }
