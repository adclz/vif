...
const CONCEPT = [
    {text: 'Core', link: '/en/concept/core'},
    {
        text: 'Architecture', collapsed: true, items: [
            {text: 'Project', link: '/en/concept/architecture/project'},
            {text: 'Providers', link: '/en/concept/architecture/providers'},
            {text: 'Task Runner', link: '/en/concept/architecture/task-runner'},
            {text: 'Agents', link: '/en/concept/architecture/agents'},
        ]
    },
    {
