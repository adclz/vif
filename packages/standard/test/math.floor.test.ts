...
const TestProgram = () => {
    const fb = new Fb({
            ...
            body() {
                return [
                    new Assign(this.temp.test_real, new Floor(new Real(0.9))),
                    new UnitTest("Real Floor", this.temp.test_real, "=", 0.000000),

                    new Assign(this.temp.test_lreal, new Floor(new LReal(0.9))),
                    new UnitTest("LReal Floor", this.temp.test_lreal, "=", 0.00000000000),
                ]
            }
        }
    )
        ...
        blocks:
            {
                ...
                "Floor_Fb": fb,
                "Floor_Fb_Instance": fbInstance
            }
    })
}

describe("Simulation primitives", async () => {
    describe("Floor Values", async () => {
        describe("Simulation tests", async () => {
            ...
            describe("Compiler output", () => {
                ...
                it("output", () => {
                    ...
                    expect(output["file:///Floor_Fb"]).to.toMatchObject([
                        "FUNCTION_BLOCK \"Floor_Fb\"",
