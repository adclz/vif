...
const TestProgram = () => {
    const fb = new Fb({
            ...
            body() {
                return [
                    new Assign(this.temp.test_real, new Round(new Real(0.9))),
                    new UnitTest("Real Round", this.temp.test_real, "=", 1.000000),

                    new Assign(this.temp.test_lreal, new Round(new LReal(0.9))),
                    new UnitTest("LReal Round", this.temp.test_lreal, "=", 1.00000000000),
                ]
            }
        }
    )
        ...
        blocks:
            {
                ...
                "Round_Fb": fb,
                "Round_Fb_Instance": fbInstance
            }
    })
}

describe("Simulation primitives", async () => {
    describe("Round Values", async () => {
        describe("Simulation tests", async () => {
            ...
            describe("Compiler output", () => {
                ...
                it("output", () => {
                    ...
                    expect(output["file:///Round_Fb"]).to.toMatchObject([
                        "FUNCTION_BLOCK \"Round_Fb\"",
