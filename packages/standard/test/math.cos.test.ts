...
const TestProgram = () => {
    const fb = new Fb({
            ...
            body() {
                return [
                    new Assign(this.temp.test_real, new Cos(0.9)),
                    new UnitTest("Real cos", this.temp.test_real, ">=", 0.62161),

                    new Assign(this.temp.test_lreal, new Cos(0.9)),
                    new UnitTest("LReal cos", this.temp.test_lreal, ">=", 0.621609968270664),
                ]
            }
        }
    )
        ...
        blocks:
            {
                ...
                "Cos_Fb": fb,
                "Cos_Fb_Instance": fbInstance
            }
    })
}

describe("Simulation primitives", async () => {
    describe("Cos Values", async () => {
        describe("Simulation tests", async () => {
            ...
            describe("Compiler output", () => {
                ...
                it("output", () => {
                    ...
                    expect(output["file:///Cos_Fb"]).to.toMatchObject([
                        "FUNCTION_BLOCK \"Cos_Fb\"",
