    ...
    const fb = new Fb({
            interface: {
                temp: {
                    ...
                    test_ltime: LTime_from({s: 10, ms: 10})
                }
            },
            body() {
                return [
                    ...
                    new UnitTest("LWord div", this.temp.test_lword, "=", 4),
                    ...
                    new UnitTest("ULInt div", this.temp.test_ulint, "=", 4),
                    new Assign(this.temp.test_lint, new Calc(this.temp.test_lint, "/", 2)),
                    new UnitTest("LInt div", this.temp.test_lint, "=", 4),
                    ...
                    new UnitTest("LTime div", this.temp.test_ltime, "=", LTime_from({s: 5, ms: 5})),
                ]
            }
        }
    )
